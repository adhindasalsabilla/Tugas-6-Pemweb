...
<body background="biobg.jpeg">
       <center><h1 ><font style="background-color:black; color:white">Masukkan Data Biodata Anda</h1></center></font>
</body>
<form action="outputbiodata.php" method="POST" NAME="input" enctype="multipart/form-data">
<table>
<tr>
<td></td>
<td><font style= "background-color:black; color:white" face="Century Gothic" size="3">NPM</font></td>
